...
//      Assert.assertTrue(dl1._output._training_metrics.mse() < dl2._output._training_metrics.mse());
  ...
  @Test public void testQuasibinomial(){
    ...
    try {
      ...
      params._epochs = 1000;
      params._hidden = new int[]{20, 20, 20};
      params._nfolds = 3;
      ...
      DeepLearning gbm = new DeepLearning(params);
      ...
      DeepLearning gbm2 = new DeepLearning(params);
      ...
      assertEquals(
          ...
          ((ModelMetricsRegression)model2._output._training_metrics).residual_deviance() * 0.5, 5e-2);

      // compare CV metrics of both models
      assertEquals(
          ((ModelMetricsBinomial)model._output._cross_validation_metrics).logloss(),
          ((ModelMetricsRegression)model2._output._cross_validation_metrics).residual_deviance() * 0.5, 5e-2);
    } finally {
      preds.delete();
      preds2.delete();
      fr.delete();
